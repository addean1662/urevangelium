  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2">
          <Card title="English evidence system"><p><strong>All 48,275 Sahidic word-groups are processed by a deterministic multi-source evidence ledger.</strong> It displays 43,901 KELLIA/CCL lexical aids and 1,724 SCRIPTORIUM entity identities. Parenthetical catalogue descriptions are omitted from the compact English display but preserved in provenance. A small asterisk follows these identities, with <em>*SCRIPTORIUM supplied</em> beneath the table. Another 2,650 units remain blank.</p><p>Each output retains its contributing source and evidence role. Qualified Horner units may later supply verbatim contextual English after Horner&apos;s Coptic passes the Sahidica applicability gate. CrossWire may corroborate Coptic readings, but cannot supply English because its module contains no English. No source is credited with evidence it does not contain.</p></Card>
