  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2">
          <Card title="English evidence system"><p><strong>All 48,275 Sahidic word-groups are processed by a deterministic multi-source evidence ledger.</strong> It currently displays 43,850 KELLIA/CCL lexical aids, 1,343 contextually corroborated SCRIPTORIUM name components, and 92 orange site-generated contextual aids. Parenthetical catalogue descriptions and biographical entity expansions are omitted from the compact English display but preserved in provenance. Another 2,990 units remain blank rather than guessed.</p><p>For a SCRIPTORIUM name component to display, the comparative grid must corroborate that exact component in the same row, or at least two traditions must corroborate it within a two-row window where word order differs. Orange contextual aids require one unanimous direct English output for the identical Sahidica lemma elsewhere plus the same comparative-context gate. The comparative traditions establish context and placement; they do not become the source of Sahidic English.</p></Card>
