...
const figures = [
  ...
  ['35,569', 'tokens accepted in the source-order shadow'], ['25,013', 'rows carrying papyrus evidence'],
  ['3,414', 'damaged-but-readable tokens admitted'], ['32', 'disagreements preserved'],
];
...
export default function EarliestPapyriPage() {
  return <div className="flex min-h-screen flex-col">
    ...
    <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
      ...
      <section className="mt-12 grid gap-7 lg:grid-cols-2">
        <Card title="Damage and loss"><dl className="space-y-4"><div><dt className="font-semibold text-semantic-damaged">damaged</dt><dd className="mt-1">Characters remain traceable and a supported word can be shown. Damage does not automatically mean illegibility.</dd></div><div><dt className="font-semibold text-semantic-lacuna">lost dots</dt><dd className="mt-1">The papyrus text is physically missing or not preserved. No later manuscript fills it.</dd></div><div><dt className="font-semibold text-ink-primary">supplied</dt><dd className="mt-1">Editorial restoration remains distinct from physically extant letters.</dd></div></dl></Card>
        <Card title="Certification gap"><p>The latest shadow accepted 35,569 tokens with zero collisions, missing target rows, non-papyrus mutation errors, or coverage-application errors. It deliberately held 16,279 conditioned and 3,435 unresolved tokens.</p><p className="mt-3">Final certification requires pinned source revisions, CNTR-to-INTF condition review, removal or explicit labeling of all 137 coverage stubs, resolution of unsupported placements, and a separate English audit.</p></Card>
      </section>
