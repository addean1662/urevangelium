...
export const COLUMN_SOURCES: ColumnSourceRecord[] = [
  ...
  },
  {
    ...
    prohibited: ['Calling this text Weber–Gryson/Stuttgart', 'Dating the displayed edition to 383 CE', 'Dropping excess source words', 'Presenting Whitaker lexical output as contextual translation'], nextAction: 'Pin the exact upstream digital revision, independently collate the local transcription, and acquire a published Clementine-compatible English translation layer.',
  },
  {
