...
| Peshitta | Electronic received Peshitta text | Local Peshitta source pending exemplar identification | Exact token concordance and RTL order; separate text certification from gloss certification | Provisional |
