...
| Bezae | Bilingual manuscript, GA 05 / VL 5 | Hash-pinned ITSEE/IGNTP Greek and Latin TEI | Certify the readings and status markers actually displayed; preserve both sides and distinguish physical loss from comparison gaps | Display scope source-verified |
| Peshitta | Pinned scrollmapper electronic Peshitta text | `Peshitta.txt` at commit `ba07bc991644d82b24426b920245eb4422daa769` | Exact token concordance and RTL order; keep every Murdock verse independent; admit English to a Syriac cell only through lexical or governed corpus evidence; use explicit English-only expansion rows otherwise | Source text, governed alignment, and cell-level Murdock English verified |
