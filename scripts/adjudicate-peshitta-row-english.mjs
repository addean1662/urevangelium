...
const SEMANTIC_GROUPS = [['think','contemplate','ponder','imagine'],['beget','conceive','generate','bear','birth','nativity','generation','genealogy','origin'],['say','speak','announce','affirm'],['see','appear','behold','visible','perceive'],['receive','take'],['fear','afraid'],['wife','woman']];
...
const core={standard:'Every Murdock verse is independent. English is placed with its Syriac parent only by SEDRA lexical evidence, governed parallel-corpus evidence, exact agreement of at least two independent displayed tradition families, or attachment of a function word to an adjacent supported English head. No Syriac source cell may carry more than three Murdock words. Otherwise the wording is preserved in an explicit English-only expansion row. Proportional distribution, merged cells, continuation cells, arrows, and cross-verse spans are prohibited.',totals,decisions},adjudicationSha256=sha256(JSON.stringify(core));
